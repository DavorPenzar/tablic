...
Zbog toga što se karta koju će odigrati bira prije nego šte se u obzir uzimaju mogući potezi za pojedinu kartu, prednost pri biranju odigrane karte nemaju one karte koje omogućuju veći izbor poteza, nego su sve kartje jednakovjerojatne.

**Napomena.** Slučajni igrač više služi kao nekakva jednostavna i pregledna demonstracija implementacije robota igrača nego kao nekakav pravi robotski igrač. Naime, upravo zato što njegovi potezi ne ovise ni o čemu osim po tome što se od svih legalnih poteza slučajnim odabirom bira jedan među njima, nije moguće predviđati njegovu uspješnost ni računati s time da će on biti uspješan (u dvije partije s istim dijeljenjem karata i s istim protivnicima koji igraju potpuno determinističkim algoritmima, pod pretpostavkom da nijedan igrač ne odlučuje s obzirom na nekakvo mjerenje vremena, njegovi će potezi vrlo vjerojatno biti drugačiji pa eventualna pobjeda u jednoj partiji ne povlači nužno pobjedu i u drugoj partiji).
